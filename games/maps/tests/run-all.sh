...
E2E_TESTS=(e2e-app-shell.js e2e-core-objects.js e2e-vertex-editing.js e2e-selection-and-search.js e2e-multi-map.js e2e-attachments.js e2e-pwa.js e2e-keyboard-shortcuts.js e2e-sidebar-sort-filter.js)
