...
const LOCALE_PT = {
  ...
  'ui.shop.needsStone': 'Precisa de mais pedra de uma pedreira',
  ...
  'terrain.lake.hint': 'Rega as plantações vizinhas de graça',
  'terrain.lake.irrigationFact': 'Os lagos levam água aos campos vizinhos — as plantações perto de um lago são regadas automaticamente, todos os dias, de graça!',
  'terrain.lake.irrigationHint': 'Rega as plantações vizinhas todos os dias, de graça!',
  'terrain.mountain.name': 'Montanha',
  'terrain.mountain.hint': 'Toque para extrair pedra',

  'quarry.stone.name': 'Pedra',
  'quarry.stone.fact': 'As pedreiras extraem pedra das encostas das montanhas — construtores de verdade usam pedra de pedreira para paredes e fundações.',
  ...
  'ui.welcomeBack.title': 'Bem-vindo de volta!',
  'ui.welcomeBack.days': 'dia(s) passaram enquanto estavas fora.',
  'ui.welcomeBack.crops': 'cultura(s) pronta(s) para colher!',
  'ui.welcomeBack.animals': 'produto(s) animal pronto(s) para recolher!',
  'ui.welcomeBack.jobs': 'receita(s) concluída(s)!',
  'ui.welcomeBack.ok': 'Vamos lá!',
  ...
  'ui.settings.achievements': 'Conquistas',
  'ui.achievements.title': 'Conquistas',
  'ui.achievements.completedLabel': 'concluídas',
  ...
  'ui.toast.needsStone': '⛏️ Precisa de mais pedra de uma pedreira!',
